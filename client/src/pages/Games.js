...
import малайаудио from '../audios/малай.mp3';
import песиаудио from '../audios/песи.mp3';
import этаудио from '../audios/эт.mp3';
import кубэлэкаудио from '../audios/кубэлэк.mp3';
                ...
                <div className='radius-container-content'>
                    ...
                    <div>
                        <div className="cards main-content">
                            <button className='gameOpenButton' onClick={openModal}>Собери пару</button>
                            <button className='gameOpenButton' onClick={() => alert('Данная игра еще не реализована')}>Угадай слово</button>
                            <button className='gameOpenButton' onClick={() => alert('Данная игра еще не реализована')}>Викторина</button>
                        </div>
                    </div>
                </div>
            </div>
...
function MatchingGame({ openResultModal, nextGame }) {
    const items = [
        { id: 1, word: "Малай", image: малай, audio: малайаудио, borderColor: 'yellow' },
        { id: 2, word: "Песи", image: песи, audio: песиаудио, borderColor: 'orange' },
        { id: 3, word: "Эт", image: эт, audio: этаудио, borderColor: 'red' }
    ];
...
function MatchingGame2({ openResultModal, nextGame }) {
    const items = [
        { id: 1, word: "Гаилэ", image: гаилэ,  borderColor: 'pink' },
        { id: 2, word: "Кубэлэк", image: кубэлэк, audio: кубэлэкаудио, borderColor: 'red' },
        { id: 3, word: "Алма", image: алма, borderColor: 'green' }
    ];
