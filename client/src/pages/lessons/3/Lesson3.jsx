...
//       case 3:
//         return <Block4 onAnswer={handleAnswer} onBack={handleBack} /* onNext={handleNext} */ />;
//       case 4:
...
//       case 8:
//         return <Block9 onAnswer={handleAnswer} onBack={handleBack} />;
//       case 9:
//         return (
...
//               <button className='lessonEndButton getAward original-text AnswButton lessonButton'>Бүләкләрем
//                 <span className="translated-text">Мои награды</span>
//               </button>
//               <button className='lessonEndButton newLesson original-text AnswButton lessonButton'>Киләсе дәрес
//                 <span className="translated-text AnswButton">Следующий урок</span>
//               </button>
//             </div>
//           </div>
//         );
        ...
        return (
          <div className='lessonEnd'>
            ...
            <div className='endText'>
              ...
              <p cl>Афәрин! Шушы рухта дәвам ит, син дөрес юлда!</p>
            </div>
            <div className='lessonEndButtons'>
